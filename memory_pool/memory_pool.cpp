...
void memory_pool::Memory_Pool::initialize_transaction_verification_proccess() { memory_pool::cuda::launch_kernel_transaction_verification(); std::thread( &memory_pool::cuda::set_previous_data ).detach();  }
