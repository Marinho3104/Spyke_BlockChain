...
p2p::Connection::Connection() 
    : version( 0 ), end_point( 0 ), socket_descriptor( -1 ), hint( 0 ), status( P2P_SOCKET_CONNECTION_STATUS_NOT_CONNECTED ), data( 0 ), data_size( 0 ) {}
...
p2p::Connection::Connection( unsigned char __version, void* __end_point, int __socket_descriptor, void* __hint, unsigned char __status ) 
    : version( __version ), end_point( __end_point ), socket_descriptor( __socket_descriptor ), hint( __hint ), status( __status ), data( 0 ), data_size( 0 ) {}
...
bool p2p::Connection::send_packet( p2p::Packet* __packet ) { return p2p::send_packet_to( this, __packet ); }
